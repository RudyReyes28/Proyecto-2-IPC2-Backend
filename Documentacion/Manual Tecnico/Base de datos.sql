...
CREATE TABLE `consultoria_medica`.`fecha_agendada` (
  ...
  INDEX `fk_horario_age_idx` (`idhorario` ASC) VISIBLE,
  CONSTRAINT `fk_fecha_agendada`
    FOREIGN KEY (`idconsulta`)
    REFERENCES `consultoria_medica`.`consulta` (`idconsulta`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_horario_age`
    FOREIGN KEY (`idhorario`)
    REFERENCES `consultoria_medica`.`horario_atencion` (`idhorario`)
    ON DELETE CASCADE
    ON UPDATE CASCADE);
...
SELECT * FROM porcentaje_cobro;

SELECT * FROM horario_atencion;
SELECT * FROM especialidad_medico;
SELECT * FROM examen_laboratorio;
SELECT * FROM fecha_agendada;
SELECT * FROM consulta;
SELECT * FROM solicitud_examen;
SELECT * FROM examenes_solicitados;
SELECT * FROM examen_consulta;
*/