...
@WebServlet(name = "PrimeraSesionLabServlet", urlPatterns = {"/laboratorio/verificar"})
public class PrimeraSesionLabServlet extends HttpServlet {

    private final GsonUtils<Usuario> gsonUsuario;

    public PrimeraSesionLabServlet() {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (pathInfo == null || pathInfo.equals("/")) {
            ...
            boolean especialidad = VerficarInicioSesion.verificarLab(usuario);
