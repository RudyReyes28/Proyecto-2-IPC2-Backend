...
@WebServlet(name = "VerPerfilPacienteServlet", urlPatterns = {"/paciente/VerPerfil/*"})
public class VerPerfilPacienteServlet extends HttpServlet {
    
    private final GsonUtils<Usuario> gsonUsuario;

    public VerPerfilPacienteServlet() {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        var usuario = ObtenerUsuarios.obtenerUsuario("paciente","idpaciente",idUsuario);
