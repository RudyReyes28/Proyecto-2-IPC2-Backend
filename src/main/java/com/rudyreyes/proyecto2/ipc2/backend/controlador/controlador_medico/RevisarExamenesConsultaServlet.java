 ...
 * @author rudy-reyes
 */
@WebServlet(name = "RevisarExamenesConsultaServlet", urlPatterns = {"/medico/RevisarExamenes/*"})
public class RevisarExamenesConsultaServlet extends HttpServlet {

    private final GsonUtils<Consulta> gsonMedico;

    public RevisarExamenesConsultaServlet() {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        var examenes = RevisarExamenConsulta.revisarConsultas(idMedico);
        response.setStatus(HttpServletResponse.SC_OK);
        gsonMedico.sendAsJson(response, examenes);
    }
    @Override
